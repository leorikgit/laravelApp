            ...
            @if(count($post->comments) > 0)
               @foreach($post->comments as $comment)
                    <div class="media mb-4">
                        <img height="64" class="d-flex mr-3 rounded-circle" src="{{$comment->user->avatar ? $comment->user->avatar->name : ''}}" alt="">
                        <div class="media-body">
                            ...
                            @foreach($comment->replays as $replay)
                                <div class="media mt-4">
                                    <img height="64" class="d-flex mr-3 rounded-circle" src="{{$replay->user->avatar ? $replay->user->avatar->name : ''}}" alt="">
                                    <div class="media-body">
                                        <h5 class="mt-0">{{$comment->user->name}} ({{ $comment->created_at->diffForHumans() }})</h5>
                                        {{$comment->content}}
                                    </div>
